...
dygraphOutput("dygraph2")
   ...
   output$dygraph2 <- renderDygraph({
    ...
    ##why is this neccesary? because our economic data is from the World Bank
    ##and the World Bank uses country codes, not country names
    ##code2<- countrycode(as.character(clickedCountry()), "country.name", "iso3c")
    
    dygraph(indicator2[, as.character(clickedCountry())], main = clickedCountry()) %>%
...
renderDataTable({
    ...
    datatable(countryDataTable, fillContainer = TRUE, caption = 
